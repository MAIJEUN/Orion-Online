...
* 본인 및 타인의 개인정보 (전화번호, 주소 등) 을 공개하거나 요청하지 마세요.
...
* 심각한 욕설: 특정인을 공격하거나 불쾌감을 줄 수 있는 욕설 금지 (예: "ㅈ같네", "시발", "존나 웃기네", "병신").
* 선정적인 채팅: 선정적인 요소가 포함된 채팅, 자료, 이미지 등을 금지합니다.
  * 1회 위반: 경고 1회.
  * 2회 위반: 경고 2회 및 24시간 채팅 제한.
  * 3회 이상 위반: 일시적 차단 (7일).
  * 극단적 욕설: 즉각 영구 차단.
...
* 서버의 개발자, 관리자 등을 사칭하는 행위 또는 유명 유튜버를 사칭하는 행위는 서버의 혼란을 유발할 수 있으므로 금지합니다.
  * 1회 위반: 경고 2회.
...
* 채팅이 가능한 채널에서는 오리온 서버와 무관한 타 서버의 콘텐츠 언급을 금지합니다.
  * 1회 위반: 경고 1회.
  * 2회 위반: 경고 2회 및 채팅 제한 (12시간).
  * 반복 시: 일시적 차단 (3일) 또는 영구 차단.
...
>
> 또한 서버 관리자, 개발자, 길잡이 등 특별 역할을 가진 멤버가 규칙을 4번 이상 위반할 경우, 해당 역할은 즉시 박탈됩니다.

`관리자는 상황에 따라 추가적인 조치를 취할 수 있으며, 규칙에 명시되지 않은 경우에도 관리자의 판단에 따라 경고 조치를 내릴 수 있습니다.`

마지막 수정: 2025년 01월 14일 오전 01시 1분
